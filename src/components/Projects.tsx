            ...
            >
              ...
              >
                {project.imageUrl && (
                  <img 
                    ...
                    style={{
                      transform: activeProject === index ? 'scale(1.1)' : 'scale(1)',
                    }}
                  />
                )}
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                  <h3 className="text-white font-bold text-lg p-4">{project.title}</h3>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="pt-2 border-t border-gray-200 dark:border-gray-700 flex justify-end">
                  <button 
                    className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium flex items-center transition-colors duration-300"
                  >
                    View Details
                    <svg 
